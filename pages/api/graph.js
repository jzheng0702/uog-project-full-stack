 ...
 * @param {Digraph} connect - The digraph to check for the edge
 * 
 ...
 *
 * @param {String} node - The label of the node to check for
...
/**
 * Configures the style information for a node.
 *
 * @param {string} courseName - The name of the course (the label of the node)
 *
 * @returns {Object} The style information for the node.
 */
 ...
 * @param {Array} edges - The array of edges to add to
 * @param {Array} nodes - The array of nodes to add to
 *
 ...
 * @param {String} label - The label of the node to add
 * @param {Array} nodes - The array of nodes to add to
 * 
 ...
 * @param {Array} nodes - The array of nodes to add to
 * @param {Digraph} connect - The digraph to add to
 */
 ...
 * @param {String} allPreCourse - All the pre-requisite courses' name for one course
 * @param {Integer} nameCounts - Count how many "1 of" nodes are there
 * @param {Digraph} connect - The digraph to add to
 *
 * @returns {Number} New value for nameCounts
 */
 ...
 * @param {Array} courses - Array of course JSON data
 * @param {String} subject - Search term the user entered
 * @param {Digraph} result - Current working graph
 */
 ...
 *
 * @param {Digraph} connect - Current working graph
 * @param {Array} courses - all the courses for one subject/major
 * @param {Array} nodes - all the nodes for one subject/major
 */
 ...
 * @param {Object} result - the current working graph
 */
...
/**
 * Sets the parent nodes of the graph.
 * 
 * @param {Array} nodes - Array of nodes
 */
