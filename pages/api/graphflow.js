...
/**
 * Gets the prerequisites for a given course.
 * 
 * @param {String} school - School name
 * @param {Array} coursesJSON - Array of JSON course data
 * @param {String} course - Course code
 * 
 * @returns {Array} Array of prerequisites for the given course
 */
...
/**
 * Sets the style for a given node.
 * 
 * @param {String} courseName - Name of the course (label of the node)
 * 
 * @returns {Object} Object containing the style for the node
 */
...
/**
 * Sets the graph nodes for a given list of courses.
 * 
 * @param {String} school - School name 
 * @param {Array} coursesJSON - Array of JSON course data 
...
/**
 * Sets the graph edges for a given list of courses.
 * 
 * @param {Array} nodes - Array of graph nodes
 * 
 * @returns {Array} Array of graph edges
 */
 ...
 *
 * @returns {Object} Newly created edge
 */
...
/**
 * Sets the parent nodes for a given list of nodes.
 *
 * @param {Array} nodes - Array of graph nodes 
 */
